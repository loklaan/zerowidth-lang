...
var t = { OFF: String.fromCharCode(8203), ON: String.fromCharCode(8204), NL: '\n' }

var isSource = function(token) {
  return Object.values(t).includes(token);
}
...
var parseParam = function(tokenizer) {
  ...
  while (tokenizer.hasNext()) {
    ...
    if (token == t.NL) break
    if (!sign) {
      sign = { [t.OFF]: 1, [t.ON]: -1 }[token]
    } else {
      value = (value << 1) + { [t.OFF]: 0, [t.ON]: 1 }[token]
    }
  }
...
var ws = {
  ...
  compile: function(fullSource) {
    ...
    while (tokenizer.hasNext()) {
      ...
      debugToken += { [t.OFF]: '0', [t.ON]: '1', [t.NL]: 'n' }[token]
...
ws.keywords = [
  { ws: `${t.OFF}${t.OFF}`, mnemo:'push',constr:ws.WsPush,param:'NUMBER'},
  { ws: `${t.OFF}${t.NL}${t.OFF}`, mnemo:'dup',constr:ws.WsDouble,param:null},
  { ws: `${t.OFF}${t.ON}${t.OFF}`, mnemo:'copy',constr:ws.WsCopyNth,param:'NUMBER'},
  { ws: `${t.OFF}${t.NL}${t.ON}`, mnemo:'swap',constr:ws.WsSwapTop,param:null},
  { ws: `${t.OFF}${t.NL}${t.NL}`, mnemo:'drop',constr:ws.WsDropTop,param:null},
  { ws: `${t.OFF}${t.ON}${t.NL}`, mnemo:'slide',constr:ws.WsSlide,param:'NUMBER'},
  { ws: `${t.ON}${t.OFF}${t.OFF}${t.OFF}`, mnemo:'add',constr:ws.WsAddition,param:null},
  { ws: `${t.ON}${t.OFF}${t.OFF}${t.ON}`, mnemo:'sub',constr:ws.WsSubtraction,param:null},
  { ws: `${t.ON}${t.OFF}${t.OFF}${t.NL}`, mnemo:'mul',constr:ws.WsMultiplication,param:null},
  { ws: `${t.ON}${t.OFF}${t.ON}${t.OFF}`, mnemo:'div',constr:ws.WsIntDivision,param:null},
  { ws: `${t.ON}${t.OFF}${t.ON}${t.ON}`, mnemo:'mod',constr:ws.WsModulo,param:null},
  { ws: `${t.ON}${t.ON}${t.OFF}`, mnemo:'store',constr:ws.WsHeapStore,param:null},
  { ws: `${t.ON}${t.ON}${t.ON}`, mnemo:'retrieve',constr:ws.WsHeapRetrieve,param:null},
  { ws: `${t.NL}${t.OFF}${t.OFF}`, mnemo:'label',constr:ws.WsLabel,param:'LABEL'},
  { ws: `${t.NL}${t.OFF}${t.ON}`, mnemo:'call',constr:ws.WsCall,param:'LABEL'},
  { ws: `${t.NL}${t.OFF}${t.NL}`, mnemo:'jmp',constr:ws.WsJump,param:'LABEL'},
  { ws: `${t.NL}${t.ON}${t.OFF}`, mnemo:'jz',constr:ws.WsJumpZ,param:'LABEL'},
  { ws: `${t.NL}${t.ON}${t.ON}`, mnemo:'jn',constr:ws.WsJumpNeg,param:'LABEL'},
  { ws: `${t.NL}${t.ON}${t.NL}`, mnemo:'ret',constr:ws.WsReturn,param:null},
  { ws: `${t.NL}${t.NL}${t.NL}`, mnemo:'end',constr:ws.WsEndProgram,param:null},
  { ws: `${t.ON}${t.NL}${t.OFF}${t.OFF}`, mnemo:'printc',constr:ws.WsPrintChar,param:null},
  { ws: `${t.ON}${t.NL}${t.OFF}${t.ON}`, mnemo:'printi',constr:ws.WsPrintNum,param:null},
  { ws: `${t.ON}${t.NL}${t.ON}${t.OFF}`, mnemo:'readc',constr:ws.WsReadChar,param:null},
  { ws: `${t.ON}${t.NL}${t.ON}${t.ON}`, mnemo:'readi',constr:ws.WsReadNum,param:null}
]
